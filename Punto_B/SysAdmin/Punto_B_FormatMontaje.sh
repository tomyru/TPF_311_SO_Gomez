...
echo "UUID=$UUID_SDC1  /home/vagrant/sysadmin/Servicios  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Servicios] Montando partición y creando estructura inicial..."
sudo mount /home/vagrant/sysadmin/Servicios
sudo mkdir -p /home/vagrant/sysadmin/Servicios/{Base_de_Datos,Cache,Web}
...
echo "UUID=$UUID_SDC2  /home/vagrant/sysadmin/Monitoreo  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Monitoreo] Montando partición y creando subcarpetas..."
sudo mount /home/vagrant/sysadmin/Monitoreo
sudo mkdir -p /home/vagrant/sysadmin/Monitoreo/{Alertas,Logs,Metricas}
...
echo "UUID=$UUID_SDC5  /home/vagrant/sysadmin/Servicios/Web  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Web] Montando la partición lógica dentro de Servicios/Web..."
sudo mount /home/vagrant/sysadmin/Servicios/Web
...
echo "UUID=$UUID_SDC6  /home/vagrant/sysadmin/Servicios/Cache  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Cache] Montando la partición lógica dentro de Servicios/Cache..."
sudo mount /home/vagrant/sysadmin/Servicios/Cache
...
echo "UUID=$UUID_SDC7  /home/vagrant/sysadmin/Monitoreo/Logs  ext4  defaults  0  2" | sudo tee -a /etc/fstab

echo "[Logs] Montando la partición lógica dentro de Monitoreo/Logs..."
sudo mount /home/vagrant/sysadmin/Monitoreo/Logs

# =====================================================================
# SECCIÓN 6: AJUSTE FINAL DE PERMISOS GLOBAL
echo "Asignando la propiedad de todas las estructuras al usuario 'vagrant'..."
sudo chown -R vagrant:vagrant /home/vagrant/sysadmin/
